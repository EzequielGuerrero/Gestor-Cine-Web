...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex">
                <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#exampleModal">Insertar Pelicula</button>
            </form>
        </div>
    </div>
</nav>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Insertar Pelicula</h5>
            ...
            <form method="post" action="insertPeli">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nombrePeli" id="nombrePeli">
                    </div>
                    <div class="form-group">
    ...
    <div class="contenido">
        <div id="ListaPeliculas" class="lista">
            <table class="table table-striped">
                ...
                try {
                    pelis = con.leerPeliculas(con.getConexion());
                    if (pelis.isEmpty()) {
                ...
                <tr class="justify-content-center">
                    ...
                    <td>
                        <form method="post" action="ModificarPeliculas" style="display: inline;">
                ...
                <tr><td colspan='8'>Error al obtener la lista de cines</td></tr>
                <% e.printStackTrace(); } %>
            </table>
        </div>
    </div>
...
<div class="modal fade" id="exampleModalLong-<%= columnas[0] %>" tabindex="-1" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modificarPeliculas" id="modificarPeliculas">Modificar Pelicula</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form method="post" action="ModificarPeliculas">
                    <div class="form-group">
                        <label for="nuevoNombrePeli">Nuevo nombre Pelicula</label>
                        <input type="text" class="form-control" name="nuevoNombrePeli" id="nuevoNombrePeli">
                    </div>
                    <input type="hidden" name="peliId" value="<%= columnas[0] %>" />
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
