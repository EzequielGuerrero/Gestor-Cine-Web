		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Insertar Cine</h5>
				...
				<form method="post" action="insertCine">
					<div class="modal-body">
						<div class="form-group">
							<label for="formGroupExampleInput">Nombre del Cine</label> <input
								type="text" class="form-control" name="nuevoNombreCineInsert"
								id="formGroupExampleInput">
						</div>
						<div class="form-group">
							<label for="formGroupExampleInput2">Dirección del Cine</label> <input
								type="text" class="form-control" name="nuevaDireccionCine"
				...
				<table class="table table-striped">
					...
					<div class="modal fade" id="exampleModalLong-<%=columnas[0]%>"
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modificarCines" id="modificarCines">Modificar
										Cine</h5>
									<button type="button" class="btn-close" data-bs-dismiss="modal"
										aria-label="Close"></button>
								</div>
								<div class="modal-body">
									<form method="post" action="ModificarCines">
										<div class="form-group">
											<label for="formGroupExampleInput">Nombre del Cine</label> <input
												type="text" class="form-control" name="nuevoNombreCine"
												id="formGroupExampleInput" value="<%=columnas[1]%>">
										</div>
										<div class="form-group">
											<label for="formGroupExampleInput2">Dirección del
												Cine</label> <input type="text" class="form-control"
												name="nuevaDireccionCine" id="formGroupExampleInput2"
												value="<%=columnas[2]%>">
										</div>
										<input type="hidden" name="cineId" value="<%=columnas[0]%>" />
										<div class="modal-footer">
